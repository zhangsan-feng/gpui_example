            ...
            .child(
                v_virtual_list(
                    ...
                    |view, visible_range, _, cx| {
                        visible_range
                            .map(|index| {
                                let group_id = view.search_result.groups[index].id.clone();
                                h_flex()
                                    .w_full()
                                    .h(px(70.))
                                    .justify_between()
                                    ...
                                    .child(
                                        h_flex()
                                            ...
                                            .child(
                                                Avatar::new()
                                                    .src(view.search_result.groups[index].avatar.clone())
                                                    .size(px(40.))
                                            )
                                            .child(
                                                Label::new(view.search_result.groups[index].name.clone())
                                            )
                                    )
                                    .child(
